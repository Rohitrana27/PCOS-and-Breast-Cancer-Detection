...
path1 = 'D:/Final code/100% code breast cancer/breast_dataset/training/3'    #path of folder of images    
path2 = 'D:/Final code/100% code breast cancer/breast_dataset/training_set/3'  #path of folder to save images    
